...
export class RestaurantListComponent implements OnInit {
   restaurantList:Observable<any[]>
    id:number;
    restaurantObject:Observable<any>
  constructor(private zonionsserve:ZonionsServService,private router:Router,private activatedRoute:ActivatedRoute) { }
  ...
  deleteRestaurant(id:number){
        this.zonionsserve.deleteResto(id).subscribe(data=>{
          console.log(data)
          this.reload();
    ...
    changeStatus(id:number){
      ...
      this.zonionsserve.getRestoId(id).subscribe(resp=>{
          ...
          this.zonionsserve.changeStatus(id,this.restaurantObject).subscribe(data=>{
            console.log(data);
            this.reload();
      },error=>console.log(error))
